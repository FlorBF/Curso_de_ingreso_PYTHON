...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        #necesito el importe actualizado con el descuento
        ...
        importe_descuento = importe_numero * descuento_numero / 100
         #                        ej:1000         ej:10 / 100 = ej: 100 = imp descuento
        importe_total_actualizado = importe_numero - importe_descuento
        #     900         =   1000    -     100

        alert ("descuento",f"importe actualizado con descuento: {importe_total_actualizado}")
